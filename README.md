...
📄 Informe completo con gráficos: [[`docs/Código_Encuesta_Salud.html`](docs/Código_Encuesta_Salud.html](https://alejandravillarperdomo-ops.github.io/esde-2023-analisis/analisis_encuesta_salud.html))
## Autora
